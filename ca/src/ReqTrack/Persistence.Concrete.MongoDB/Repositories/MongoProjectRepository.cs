...
namespace ReqTrack.Persistence.Concrete.MongoDB.Repositories
{
    public class MongoProjectRepository : MongoBaseRepository, IProjectRepository
    {
        ...
        public CreateResult<Project> CreateProject(Project project)
        {
            ...
            return new CreateResult<Project>(true, mongoProject.ToDomainEntity(mongoUser));
        }
        ...
        public ReadResult<Project> ReadProject(Identity id, bool loadRequirements, bool loadUseCases)
        {
            ...
            return new ReadResult<Project>(true, mongoProject.ToDomainEntity(mongoUser, requirements?.ToEnumerable()));
        }
        ...
        public UpdateResult<Project> UpdateProject(Project project, bool updateUseCases)
        {
            var projectWithSameNameOfAuthor = Builders<MongoProject>.Filter
            ...
            return new UpdateResult<Project>(true, mongoProject.ToDomainEntity(mongoUser));
        }
        ...
        public UpdateResult<Project> UpdateProjectRequirements(Project project, RequirementType type)
        {
            ...
            var readResult = ReadProjectRequirements(project.Id, type);

            return new UpdateResult<Project>(true, readResult.Read);
        }
